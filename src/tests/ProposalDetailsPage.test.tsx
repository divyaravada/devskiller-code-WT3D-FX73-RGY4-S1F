...
const renderProposalDetailsPage = (props: ComponentProps<typeof ProposalDetailsPage>) =>
    render(
        <MemoryRouter>
...
const setupHTTPMocks = (mockData: Parameters<typeof mockConferenceTalkDetails>[0]) => {
