...
import { ConferenceTalk, CallForPapers, ConferenceTalkDetails } from "./model";

const MAX_LATENCY_IN_MILLIS = 2000;

// Part of data was generated with Faker.js ( https://github.com/marak/Faker.js/ )
const talksData: ConferenceTalkDetails[] = [
    {
...
let callForPapersData: CallForPapers = {
    byTalkId: {
...
export const setupFakeHTTP =
    (): void => {
        ...
        httpMock
            .onGet("/talks")
            .reply(() => {
                const basicTalksData: ConferenceTalk[] = talksData.map(talk => ({
                    id: talk.id,
                    title: talk.title,
